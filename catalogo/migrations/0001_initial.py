# Generated by Django 4.1.3 on 2022-11-04 20:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaDeceso', models.DateField(blank=True, null=True, verbose_name='Fallecio')),
            ],
        ),
        migrations.CreateModel(
            name='Genero',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(help_text='Ingrese el nombre del genero (xej.Programacion, BD, SO, etc)', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Libro',
